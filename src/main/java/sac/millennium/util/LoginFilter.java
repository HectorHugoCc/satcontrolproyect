...
import sac.millennium.controller.LoginBean;
...
public class LoginFilter implements Filter {
	...
	private boolean noProteger(String urlStr) {
		...
		/*
		 * Este es un buen lugar para colocar y programar todos los patrones que creamos
		 * convenientes para determinar cuales de los recursos no requieren protección.
		 * Sin duda que habría que crear un mecanizmo tal que se obtengan de un archivo
		 * de configuración o algo que no requiera compilación.
		 */
